...
import (
	...
	mgAdmsn "kubedb.dev/autoscaler/pkg/admission"
...
// AutoscalerServer contains state for a Kubernetes cluster master/api server.
type AutoscalerServer struct {
	GenericAPIServer *genericapiserver.GenericAPIServer
	Operator         *controller.Controller
}

func (op *AutoscalerServer) Run(stopCh <-chan struct{}) error {
...
func (c *AutoscalerServerConfig) Complete() CompletedConfig {
...
// New returns a new instance of AutoscalerServer from the given config.
func (c completedConfig) New() (*AutoscalerServer, error) {
				...
				go func() {
					xray := reg_util.NewCreateValidatingWebhookXray(c.OperatorConfig.ClientConfig, apiserviceName, &api.MongoDB{
						...
						ObjectMeta: metav1.ObjectMeta{
							Name:      "test-autoscaler-for-webhook-xray",
							Namespace: "default",
						},
